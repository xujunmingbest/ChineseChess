...
#pragma endregion
	private: System::Void MainWnd_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Columns->Add("当前桌子");
		listView1->Columns->Add("头像");
	}

			 String ^GetStatus(int status) {
				 switch (status) {
				 case	 GAMESTATUS_NOTLOGIN: return "没有登入";
				 case	 GAMESTATUS_LOGIN : return "已登入";
				 case	 GAMESTATUS_INTABLE:return "在桌子中";

				 case	 GAMESTATUS_OUTLINE:return "不在线";
				 case	 GAMESTATUS_NOTREADY:return "未准备";
				 case	 GAMESTATUS_READY :return "已准备";
				 case	 GAMESTATUS_GAMEING:return "正在下棋中";
				 case	 GAMESTATUS_WATCHING:return "正在观看别人下棋";
				 case	 GAMESTATUS_LOSE:return "输棋";
				 case		 GAMESTATUS_WIN:return "赢棋";
